...
public class OutputScreen extends javax.swing.JFrame {
    ...
    public OutputScreen(DefaultTableModel model){
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Inputscreen in = new  Inputscreen();
        in.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OutputScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
